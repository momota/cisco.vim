...
syn keyword ciscoKeyword    logging log login password username user license host hostname
syn keyword ciscoKeyword    address network route neighbor redistribute default-gateway community
syn keyword ciscoKeyword    version class switchport clock name minimum maximum
...
syn keyword ciscoProtocol   klogin kshell login rlogin
...
syn keyword ciscoProtocol   pki isakmp ipsec ike esp gre vpn mvpn pppoe
syn keyword ciscoProtocol   qos cef pim ahp tacacs
syn keyword ciscoProtocol   cdp vtp spanning-tree lacp dot1Q l2tun ethernet
...
syn keyword ciscoVar        trunk access full full-duplex auto active
